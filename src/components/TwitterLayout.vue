  ...
  <div class="fixed w-full">
    <div class="max-w-[1400px] flex mx-auto">
      ...
      >
        ...
        >
          <div class="border-gray-800 border-b w-full font-extrabold p-4 text-[21px]">Home</div>
          <div class="flex">
            <div
      ...
      <div class="lg:block hidden lg:w-4/12 h-screen border-1 border-gray-800 pl-4 mt-2">
        ...
        <div class="w-full mt-4 rounded-lg lg:block hidden bg-[#212327]">
            ...
            <div class="h-[90px] hover:bg-gray-800 cursor-pointer transition duration-300 ease-in">
                <div class="flex p-3 justify-between h-[80px] py-3">
                    <div>
                        <div class="text-[14px] text-gray-400">Tennis Tournament LIVE</div>
                        <div class="w-full text-white font-extrabold mb-6 text-[17px]">Vietnam Open 2023</div>
                    </div>
                    <p v-if="selectedImage"><img style="width:100%" :src="selectedImage" alt="img" class="rounded-xl h-[60px] object-cover"></p>
                </div>
            </div>

            <div class="hover:bg-gray-800 cursor-pointer transition duration-300 ease-in">
                <div class="flex p-3 justify-between">
                    <div>
                        <div class="text-[14px] text-gray-400">Tennis Tournament LIVE</div>
                        <div class="w-full text-white font-extrabold text-[17px]">Vietnam Open 2023</div>
